    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-2 py-8 bg-[#14412D]">
      <div className="flex flex-col z-10 w-full max-w-xl items-center justify-between">
        ...
        <div className="flex w-[260px] min-h-[370px] justify-center mb-6 relative">
          <Image id="1" alt="livre 1" src={"/livre_1.png"} width={1000} height={1000} className="flex w-[260px] max-w-sm rounded-xl" />
          <Image id="2" alt="livre 2" src={"/livre_2.png"} width={1000} height={1000} className="hidden w-[260px] max-w-sm rounded-xl" />
          <Image id="3" alt="livre 3" src={"/livre_3.png"} width={1000} height={1000} className="hidden w-[260px] max-w-sm rounded-xl" />
          <Image id="4" alt="livre 4" src={"/livre_4.png"} width={1000} height={1000} className="hidden w-[260px] max-w-sm rounded-xl" />
          <Image id="5" alt="livre 5" src={"/livre_5.png"} width={1000} height={1000} className="hidden w-[260px] max-w-sm rounded-xl" />
          <Image id="6" alt="livre 6" src={"/livre_6.png"} width={1000} height={1000} className="hidden w-[260px] max-w-sm rounded-xl" />
